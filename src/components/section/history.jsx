            ...
            <div className="p-6">
                <div className="space-y-6">
                    <div className="border-border/50 flex min-h-[400px] w-full flex-col items-center justify-center rounded-lg border-2 border-dashed bg-[#1e2733]/50 p-8 text-center text-[#434f5f]">
                        ...
                        <button className="text-primary-foreground flex h-10 items-center justify-center gap-2 rounded-md bg-[#EA962D] px-4 py-2 text-sm font-medium whitespace-nowrap text-black transition-colors hover:bg-[#EA962D]/90 focus-visible:outline-none">
